...
//side-effects at the edge of the system - we need to persist to the real world
//at least 3 approaches to test it
//1. mock repo with expectation to the method call 
//2. cloning objects before returning from rpo
//3. actual db integration
